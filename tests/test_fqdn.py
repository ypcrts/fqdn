...
class TestFQDNValidation:
    ...
    def test_rfc_1035_s_2_3_1__label_cannot_have_inital_digit(self, a_u):
        self.__assert_invalid_fwd_and_bkwd_from_seq("www", "1", allow_underscores=a_u)
        self.__assert_invalid_fwd_and_bkwd_from_seq("1w", "1", allow_underscores=a_u)
        self.__assert_invalid_fwd_and_bkwd_from_seq("1w", "a", allow_underscores=a_u)
        self.__assert_invalid_fwd_and_bkwd_from_seq("1w1", "d", allow_underscores=a_u)
        self.__assert_invalid_fwd_and_bkwd_from_seq("111", "a", allow_underscores=a_u)
        self.__assert_invalid_fwd_and_bkwd_from_seq("www", "1a", allow_underscores=a_u)

    def test_rfc_1035_s_2_3_1__label_can_have_medial_and_terminal_digits(self, a_u):
